...
public class TableCellComponentModelImpl implements TableCellComponentModel {
    ...
    private transient static final Logger logger = Logger.getLogger(TableCellComponentModelImpl.class.getName());
    ...
    public Object getValue(JTable table, Component component, int row, int column) {
        ...
        final Object value = this.getValue(component, logger);
        
        if(value == logger) {
            throw new UnsupportedOperationException(this.getUnsupportedComponentMsg(component));
        }
        
        final Object output = value == null ? null : this.cellDisplayFormat.fromDisplayValue(table, component, value, row, column);
    ...
    public Object getValue(Component component, Object outputIfNone) {
        ...
        Object value = this.doGetValue(component, outputIfNone);
        
        logger.log(Level.FINER, "Value: {0}", value);

        value = this.format(value);
        logger.log(Level.FINER, "Value, formatted: {0}", value);
        return value;
    }
